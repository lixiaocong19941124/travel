...
<div id="demo">
    ...
    <div style="padding: 10px 0;">
        <div style="padding: 10px 0;">
            <span style="font-size: 20px;vertical-align: middle;">热卖产品</span>
        </div>
        <div>
...
<!--                                <a onclick="location.href='m2cp_2.php?rid={{dt.rid}}'">查看详情</a>-->
                                <a href='m2cp_1_jk.php'>查看详情</a>
                            </span>
